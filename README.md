...
Please make sure your fork isn't violating the following conditions!
...
My blog articles are filed under the [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/) license. Basically you are free to reuse my content for non-commercial purposes under the obligation to publish it under the same license. You'll always need to give credit and link back to the source by attributing every article with
